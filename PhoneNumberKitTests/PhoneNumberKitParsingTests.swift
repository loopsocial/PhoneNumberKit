...
class PhoneNumberKitParsingTests: XCTestCase {
    ...
    func testGBNumber() {
        do {
            ...
            let phoneNumberE164Format1 = phoneNumberKit.format(phoneNumber1, toType: .e164)
            XCTAssertTrue(phoneNumberE164Format1 == "+442070313000", "\(phoneNumberE164Format1) != +442070313000")
    ...
    func testDENumber() {
        do {
            ...
            let phoneNumberNationalFormat1 = phoneNumberKit.format(phoneNumber1, toType: .national)
            XCTAssertTrue(phoneNumberNationalFormat1 == "0291 12345678", "\(phoneNumberNationalFormat1) != 0291 12345678")
            let phoneNumberE164Format1 = phoneNumberKit.format(phoneNumber1, toType: .e164)
            XCTAssertTrue(phoneNumberE164Format1 == "+4929112345678", "\(phoneNumberE164Format1) != +4929112345678")
